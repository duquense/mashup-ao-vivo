...
require( ["js/qlik"], function ( qlik ) {
	...
	//Demais Gráficos
	app.getObject('graf_01','naHdAb');
	app.getObject('graf_01_02','jYCHp');
	...
	$('.filtro_regiao').click(function(){
		var vTexto = $(this).text();
		app.field('Regiao').clear();
		app.field('Regiao').selectValues([vTexto],true,true);
	})
